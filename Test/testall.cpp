...
cout << "m2a/=4.0: ";
cout << (m2a/=4.0);
cout << "m2a equals (1,2,3.5,4)?: " << (m2a==mat2(1.0,2.0,3.5,4.0)) << endl;
cout << "m2a notequals (1,2,3.5,4)?: " << (m2a!=mat2(1.0,2.0,3.5,4.0)) << endl;
cout << "m2a equals (2,6,14,4)?: " << (m2a==mat2(2.0,6.0,14.0,4.0)) << endl;
cout << "m2a notequals (2,6,14,4)?: " << (m2a!=mat2(2.0,6.0,14.0,4.0)) << endl;
printf("--------  mat3  --\n");
