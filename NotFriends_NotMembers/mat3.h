...
template <class T>
Mat3<T> operator+ (const Mat3<T> &L, const Mat3<T> &R)
	{
	Mat3<T> c;
...
template <class T>
Vec3<T> operator* (const Mat3<T> &L, const Vec3<T> &R)
	{
	Vec3<T> c;
...
Mat3<T> operator* (const Mat3<T> &L, const U &R)
	{
	Mat3<T> c;
...
template <class T>
Mat3<T>& operator+= (Mat3<T> &L, const Mat3<T> &R)
	{
	L=L+R;
	return(L);
	}
...
template <class T, class U>
Mat3<T>& operator*= (Mat3<T> &L, const U &R)
	{
	L=L*R;
	return(L);
	}
...
template <class T>
bool operator== (const Mat3<T> &L, const Mat3<T> &R)
	{
