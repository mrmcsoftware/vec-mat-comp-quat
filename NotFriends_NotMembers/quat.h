...
template <class T>
Quat<T> operator+ (const Quat<T> &L, const Quat<T> &R)
	{
...
template <class T, class U>
Quat<T> operator* (const Quat<T> &L, const U &R)
	{
	return(R*L);
	}

template <class T>
Vec3<T> operator* (const Quat<T> &L, const Vec3<T> &R)
	{
	// Based on GLM
...
template <class T>
Quat<T>& operator+= (Quat<T> &L, const Quat<T> &R)
	{
...
template <class T, class U>
Quat<T>& operator*= (Quat<T> &L, const U &R)
	{
