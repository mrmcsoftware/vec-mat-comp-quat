...
template <class T>
Mat4<T> operator+ (const Mat4<T> &L, const Mat4<T> &R)
	{
	Mat4<T> c;
...
template <class T>
Vec4<T> operator* (const Mat4<T> &L, const Vec4<T> &R)
	{
	Vec4<T> c;
...
Mat4<T> operator* (const Mat4<T> &L, const U &R)
	{
	Mat4<T> c;
...
template <class T>
Mat4<T>& operator+= (Mat4<T> &L, const Mat4<T> &R)
	{
	L=L+R;
	return(L);
	}
...
template <class T, class U>
Mat4<T>& operator*= (Mat4<T> &L, const U &R)
	{
	L=L*R;
	return(L);
	}
