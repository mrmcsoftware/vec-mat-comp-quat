...
template <class T>
Mat2<T> operator+ (const Mat2<T> &L, const Mat2<T> &R)
	{
	Mat2<T> c;
...
template <class T>
Vec2<T> operator* (const Mat2<T> &L, const Vec2<T> &R)
	{
	Vec2<T> c;
...
Mat2<T> operator* (const Mat2<T> &L, const U &R)
	{
	Mat2<T> c;
...
template <class T>
Mat2<T>& operator+= (Mat2<T> &L, const Mat2<T> &R)
	{
	L=L+R;
	return(L);
	}
...
template <class T, class U>
Mat2<T>& operator*= (Mat2<T> &L, const U &R)
	{
	L=L*R;
	return(L);
	}
...
template <class T>
bool operator== (const Mat2<T> &L, const Mat2<T> &R)
	{
