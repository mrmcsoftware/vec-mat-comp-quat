...
template <class T>
Comp<T> operator+ (const Comp<T> &L, const Comp<T> &R)
	{
	return(Comp<T>(L.r+R.r,L.i+R.i));
	}

template <class T, class U>
Comp<T> operator+ (const Comp<T> &L, const U &R)
	{
...
template <class T>
Comp<T>& operator+= (Comp<T> &L, const Comp<T> &R)
	{
	L.r+=R.r; L.i+=R.i;
	return(L);
	}
...
template <class T, class U>
Comp<T>& operator+= (Comp<T> &L, const U &R)
	{
	L.r+=R;
	return(L);
	}
...
template <class T>
bool operator== (const Comp<T> &L, const Comp<T> &R)
	{
